      ...
      <div className="space-y-6">
        ...
        <div className="border-b pb-4">
          ...
          <p className="text-muted-foreground mt-2">
            Comprehensive management of Authorized Providers, their assignments, and performance metrics.
          </p>
        </div>
        ...
        <Tabs defaultValue="assignments" className="space-y-4">
          ...
          <TabsContent value="assignments" className="space-y-4">
            <Card>
              <CardHeader>
                <CardTitle>Provider Assignment Manager</CardTitle>
                <CardDescription>
                  View all AP users, their location assignments, team assignments, and make changes.
                  This addresses the UI/UX disconnect by providing a unified management interface.
                </CardDescription>
              </CardHeader>
              <CardContent>
