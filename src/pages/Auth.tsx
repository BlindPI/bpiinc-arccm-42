...
const HeroSection = () => <div className="flex flex-col justify-center h-full p-8 md:p-12 bg-gradient-to-br from-primary-700 to-secondary text-white">
    <div className="max-w-xl mx-auto">
      <h1 className="text-4xl md:text-5xl font-bold mb-6">
        ...
        <span className="text-blue-200 block mt-2">Made Simple.</span>
      </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
        <div className="bg-white/10 p-6 rounded-lg backdrop-blur-sm">
          ...
          <p className="text-gray-200">Track certifications, licenses, and training statuses in real-time across your organization.</p>
        </div>
        ...
        <div className="bg-white/10 p-6 rounded-lg backdrop-blur-sm">
          ...
          <p className="text-gray-200">Automated alerts for expiring documents and actionable insights to close compliance gaps.</p>
        </div>
        ...
        <div className="bg-white/10 p-6 rounded-lg backdrop-blur-sm">
          ...
          <p className="text-gray-200">Collaborate seamlessly with authorized providers, instructors, and auditors in one secure platform.</p>
        </div>
      </div>
    </div>
  </div>;
...
const LegalDisclosure = () => <div className="text-xs text-gray-500 space-y-4 mt-6">
    ...
    <div className="grid grid-cols-2 gap-6 items-center mb-6">
      <div className="text-center">
        <img src="/lovable-uploads/f753d98e-ff80-4947-954a-67f05f34088c.png" alt="Assured Response Logo" className="h-10 w-auto object-contain mx-auto mb-2" />
        <span className="text-xs font-medium text-gray-600">Assured Response</span>
      </div>
      <div className="text-center">
        <img src="/lovable-uploads/ef8ccfd8-f190-4b94-a13f-65150b79dbfe.png" alt="BPI Inc. Logo" className="h-10 w-auto object-contain mx-auto mb-2" />
...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="hidden lg:block bg-gradient-to-br from-primary-700 to-secondary overflow-hidden">
      ...
      <div className="flex flex-col justify-center px-4 sm:px-6 lg:px-8 py-12 bg-gray-50">
        <div className="sm:mx-auto sm:w-full sm:max-w-[460px]">
          {/* Logo and Welcome */}
          <div className="text-center mb-8">
            <img src="/lovable-uploads/f753d98e-ff80-4947-954a-67f05f34088c.png" alt="Assured Response Logo" className="h-16 w-auto object-contain mx-auto mb-4" style={{
            minWidth: '180px'
          }} />
          ...
          <Card className="shadow-md border border-gray-100 overflow-hidden">
            ...
            <CardContent className="pb-8">
              <Tabs defaultValue="signin" className="w-full">
                <TabsList className="grid w-full grid-cols-2 mb-8 bg-gray-100/70 p-1 rounded-md">
      ...
      <div className="lg:hidden bg-gradient-to-br from-primary-700 to-secondary py-10 px-4">
        <div className="text-center text-white">
