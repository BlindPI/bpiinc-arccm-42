  ...
  return <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div className="flex items-center space-x-3">
          <Checkbox id="confirm-course-duration" checked={confirmations[0]} onCheckedChange={checked => toggleConfirmation(0, checked as boolean)} disabled={disabled} />
          <div className="space-y-1">
            <Label htmlFor="confirm-course-duration" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
        ...
        <div className="flex items-center space-x-3">
          <Checkbox id="confirm-content-completion" checked={confirmations[1]} onCheckedChange={checked => toggleConfirmation(1, checked as boolean)} disabled={disabled} />
          <div className="space-y-1">
            <Label htmlFor="confirm-content-completion" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
        ...
        <div className="flex items-center space-x-3">
          <Checkbox id="confirm-attendance" checked={confirmations[2]} onCheckedChange={checked => toggleConfirmation(2, checked as boolean)} disabled={disabled} />
          <div className="space-y-1">
            <Label htmlFor="confirm-attendance" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
        ...
        <div className="flex items-center space-x-3">
          <Checkbox id="confirm-teaching" checked={confirmations[3]} onCheckedChange={checked => toggleConfirmation(3, checked as boolean)} disabled={disabled} />
          <div className="space-y-1">
            <Label htmlFor="confirm-teaching" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
