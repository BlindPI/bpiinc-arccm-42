...
import {
  ShieldCheck, FileText, CheckCircle, AlertCircle, Clock, BookOpen,
  Award, FilePen, CalendarCheck, GraduationCap // Added new icons
} from 'lucide-react';
...
import type { DatabaseUserRole } from '@/types/database-roles'; // Import DatabaseUserRole
 ...
 export function ICDashboard() {
   ...
   if (userProfile.role !== 'IC') { // Use userProfile.role here
    ...
    <div className="space-y-6">
      <Card className="w-full">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <ShieldCheck className="h-5 w-5" />
            IC Compliance Dashboard - {currentUser.display_name}
          </CardTitle>
          <CardDescription>
