  ...
  useEffect(() => {
    ...
    const complianceChannel = supabase
      ...
      .on('postgres_changes', {
        ...
        queryClient.invalidateQueries(['ui-requirements', targetUserId]);
        queryClient.invalidateQueries(['compliance-progress', targetUserId]);
        queryClient.invalidateQueries(['compliance-activity', targetUserId]);
      ...
      .on('postgres_changes', {
        ...
        queryClient.invalidateQueries(['compliance-tier', targetUserId]);
      ...
      .on('postgres_changes', {
        ...
        queryClient.invalidateQueries(['compliance-tier', targetUserId]);
        queryClient.invalidateQueries(['tier-history', targetUserId]);
      })
      .subscribe();
  ...
  useEffect(() => {
    ...
    const templatesChannel = supabase
      ...
      .on('postgres_changes', {
        ...
        queryClient.invalidateQueries(['requirements-by-category']);
        queryClient.invalidateQueries(['ui-requirements']);
      })
      .subscribe();
  ...
  useEffect(() => {
    ...
    const reviewChannel = supabase
      ...
      .on('postgres_changes', {
        ...
        queryClient.invalidateQueries(['reviewer-stats']);
      })
      .subscribe();
