...
BEGIN
  ...
  RAISE NOTICE 'Email campaigns table columns updated successfully';
END $$;
...
BEGIN
  ...
  RAISE NOTICE 'Email templates table structure updated successfully';
END $$;
...
BEGIN
  ...
  RAISE NOTICE 'Workflow templates table structure updated successfully';
END $$;
