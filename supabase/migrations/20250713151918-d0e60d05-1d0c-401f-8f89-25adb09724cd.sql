-- Update the database function to return proper structure and fix any remaining issues
...
BEGIN
    ...
    INTO total_teams_count, active_teams_count, inactive_teams_count, suspended_teams_count, avg_performance, avg_compliance
    FROM public.teams;
