-- Fix for missing columns in crm_pipeline_stages table
-- Run this SQL in Supabase SQL Editor to fix the pipeline stages issue
...
-- Add unique constraint on stage_order if it doesn't exist
DO $$
BEGIN
    IF NOT EXISTS (
...
-- Now insert the default pipeline stages
...
SELECT stage_name, stage_description, stage_order, probability_percentage, stage_color
