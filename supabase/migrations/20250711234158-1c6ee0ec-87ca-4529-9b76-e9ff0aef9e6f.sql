-- Remove Thinkific integration from database - Fixed
...
DROP FUNCTION IF EXISTS public.find_or_create_student_profile(character varying,character varying,character varying,character varying,jsonb);

-- Create updated find_or_create_student_profile function without Thinkific
