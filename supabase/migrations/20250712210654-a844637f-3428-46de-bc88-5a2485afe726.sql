-- Clean up team RLS policies and recreate them properly
...
-- Create the single comprehensive policy for SA/AD users that covers all operations
...
-- Add notice about completion
DO $$
BEGIN
    RAISE NOTICE 'Team RLS policies have been cleaned up and recreated successfully';
END $$;